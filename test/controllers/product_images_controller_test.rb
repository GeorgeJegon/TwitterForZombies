...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { image: @product_image.image, position: @product_image.position, product_id: @product_image.product_id, status: @product_image.status }
    end
  ...
  test "should update product_image" do
    patch :update, id: @product_image, product_image: { image: @product_image.image, position: @product_image.position, product_id: @product_image.product_id, status: @product_image.status }
    assert_redirected_to product_image_path(assigns(:product_image))
  end
