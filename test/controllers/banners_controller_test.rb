...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { caption: @banner.caption, image: @banner.image, order: @banner.order, status: @banner.status, title: @banner.title }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { caption: @banner.caption, image: @banner.image, order: @banner.order, status: @banner.status, title: @banner.title }
    assert_redirected_to banner_path(assigns(:banner))
  end
